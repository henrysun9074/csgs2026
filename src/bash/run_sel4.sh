#!/bin/bash
#SBATCH --job-name=csgs_coxp_wild
#SBATCH --partition=common
#SBATCH --output=/work/hs325/csgs2026/src/logs/csgs_coxp_wild.out
#SBATCH --error=/work/hs325/csgs2026/src/logs/csgs_coxp_wild.err
