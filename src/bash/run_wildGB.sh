#!/bin/bash
#SBATCH --job-name=csgs_wildGB
#SBATCH --partition=scavenger
#SBATCH --output=/work/hs325/csgs2026/src/logs/csgs_wildGB.out
#SBATCH --error=/work/hs325/csgs2026/src/logs/csgs_wildGB.err
...
# Base paths
DATA_ROOT="/work/hs325/csgs2026/data/wildlines"
GENO_PATH="${DATA_ROOT}/geno/wild_all_geno.csv"
PHENO_PATH="${DATA_ROOT}/pheno/wild_all_pheno.csv"
HPT_ITERATIONS=50
...
for SCRIPT in "${SCRIPTS[@]}"; do
    ...
    TARGET_OUTDIR="gebvs_v2/${SCRIPT_NAME}"
