...
def run_outer_fold(fold, train_idx, test_idx, X, y, ids, best_params, seed=42):
    ...
    for name, params in best_params.items():
        ...
        # Metrics to record - AUC, logloss, Brier score, Pearson correlation
...
def main():
    ...
    #  Nested CV with 10 iterations calling the 5-fold crossval 
    ...
    # Compute GEBVs and standard deviations for each animal in the dataset
    final_records = []
